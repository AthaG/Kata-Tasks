...
Each book has a code c of 3, 4, 5 or more characters. The 1st character of a code is 
a capital letter which defines the book category.
...
(in Haskell/Clojure/Racket a list of pairs):
    ...
    A, 114 the sum corresponding to "BKWRK" and "BTSQZ", 50 corresponding to "CDXEF" 
