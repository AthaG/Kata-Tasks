...
The Morse code table is preloaded for you as a dictionary, feel free to use it:
    ...
    NASM: a table of pointers to the morsecodes, and a corresponding list of ascii 
    symbols
...
def decodeMorse(morse_code):
    final = [c.split() for c in morse_code.split('   ')]
    return ' '.join(''.join(MORSE_CODE[k] for k in i) for i in final).strip()
